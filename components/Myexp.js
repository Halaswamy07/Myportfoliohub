                ...
                <div className="shadow mb-3 b-radius-5">
                  <div className="card-header py-3">
                    <div className="btn" data-bs-toggle="collapse" href="#collapseOne" >
                      <p className='margin-0 light'>Candidate Application Form  <a href='https://vyzen1.netlify.app/' target='_blank' className='link_heightlight bold'>Company Task</a></p>
                    </div>
                  </div>
                ...
                <div className="shadow mb-3 b-radius-5">
                  <div className="card-header py-3">
                    <div className="collapsed btn" data-bs-toggle="collapse" href="#collapseTwo">
                      <p className='margin-0 light'> My All Projects <a href='https://github.com/halaswamy07/' target='_blank' className='link_heightlight bold'>GitHub</a> </p>
                    </div>
                  </div>
